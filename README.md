...
[Quick Start](#quick-start) · [Features](#features) · [Architecture](#architecture) · [Deliverables](#deliverables)
...
A full walkthrough video covering the topic overview, technology evolution, Cotiviti strategic analysis, live application demo, and recommendations is included as part of the assessment submission.
...
### 1. Clone and install
```bash
git clone https://github.com/nanda-81/cotiviti-assessment.git
cd cotiviti-assessment
...
```
┌─────────────────────────────────────────────────────────────┐
│                    CLINICALIQ APPLICATION                    │
│                                                              │
│  Upload PDF/TXT                                              │
│       │                                                      │
│       ▼                                                      │
│  core/pdf_parser.py     ← pdfplumber + PyPDF2 fallback       │
│       │                                                      │
│       ▼                                                      │
│  core/llm_engine.py     ← Gemini 2.5 Flash + prompt eng.    │
│       │         └──────────── 3-stage JSON repair           │
│       ▼                                                      │
│  core/data_models.py    ← Pydantic v2 validation            │
│       │                                                      │
│       ▼                                                      │
│  ui/insights_panel.py   ← Streamlit dashboard               │
└─────────────────────────────────────────────────────────────┘
```
...
| **Demo Video** | [Watch Here](VIDEO_LINK_HERE) | Full walkthrough + live demo |
