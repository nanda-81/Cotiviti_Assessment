...
# These strings are intentionally synthetic and do not resemble any real credential format.
FAKE_AIZA_KEY = "TEST-LEGACY-CREDENTIAL-UNIT-TEST-ONLY-XXXXXXXXXXXXXXXX"
FAKE_AQ_KEY   = "TEST-MODERN-CREDENTIAL-UNIT-TEST-ONLY-XXXXXXXXXXXXXXXX"
FAKE_FUTURE   = "TEST-FUTURE-CREDENTIAL-UNIT-TEST-ONLY-XXXXXXXXXXXXXXXX"
...
class TestSecretMasking:
    ...
    def test_mask_aq_credential(self):
        ...
        assert masked.startswith(FAKE_AQ_KEY[:4])
